...
**Skills selection:** Read `future-reference/skills-catalog/CATALOG.md`. Select skills that match the known workflow needs identified in Phase 2.5. Engineering skills for the build. Production skills for AI projects. Design skills for UI work. Workflow skills for session management and quality control. Don't select everything — select what the project actually needs, because unused skills add noise without value.
